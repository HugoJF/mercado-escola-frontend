...
export const Toggle: NextPage<NativeProps & ExtraProps> = ({id, name, placeholder, children, ...rest}) => {
    ...
    >
        ...
        <label
            htmlFor={'#' + id}
            className="duration-150 flex items-center justify-center p-6 bg-white hover:bg-gray-100 peer-checked:bg-blue-600 peer-checked:text-white cursor-pointer">
            {children}
        </label>
    </div>;
};
